...
Scribe is a native Rust desktop app built with egui/eframe. It captures microphone audio locally, prepares it in native workers, runs the selected model in a private persistent inference child, and only sends the completed transcript to copy, history, overlay, or optional insertion.
